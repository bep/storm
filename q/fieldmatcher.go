...
func (d fieldMatcherDelegate) Match(i interface{}) (bool, error) {
	v := reflect.Indirect(reflect.ValueOf(i))
	return d.MatchValue(&v)
}

func (d fieldMatcherDelegate) MatchValue(v *reflect.Value) (bool, error) {
	field := v.FieldByName(d.Field).Interface()
	return d.MatchField(field)
}
